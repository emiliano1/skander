...
const Faq3 = () => {
  ...
  return (
    <>
    <section className="faq-section-two style-two">
      <div className="bg bg-image" style={{ backgroundImage: 'url(images/background/14.jpg)' }}></div>
      <div className="icon-plane-8"></div>
        ...
        <div className="outer-box">
          <div className="row">
            <div className="form-column col-lg-6 wow fadeInLeft">
              <div className="inner-column"> 
                <div className="contact-form-two wow fadeInLeft">
                  <div className="bg-pattern-2 bounce-x"></div>
                  <h3 className="title words-slide-up text-split">Request A Quote</h3>
            ...
            <div className="faq-column col-xl-6 col-lg-5 order-lg-2 wow fadeInRight" data-wow-delay="300ms">
              <div className="inner-column">
                <div className="sec-title light"> <span className="sub-title">Faq's</span>
                  <h2 className="words-slide-up text-split">Frequently <br/>Asked Questions</h2>
                </div>
