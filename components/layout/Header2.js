                    ...
                    <div className="inner-container">
                        ...
                        <div className="top-right"> 
                            ...
                            <ul className="list-style-one light">
                                <li><i className="fal fa-clock"></i> Monday - Friday: 9.00am - 6.00pm EST</li>
                                <li><i className="far fa-map-marker-alt"></i> Rockford, Illinois 61101</li>
                                <li><i className="far fa-envelope"></i> <a href="mailto:operations@skanderglobal.com">operations@skanderglobal.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="header-lower">
                    ...
                    <div className="main-box">
                        <div className="logo-box">
                            <div className="logo"><Link href="/"><img src="/images/logo-3.png" alt="" title="Skander Global" /></Link></div>
                        </div>
                        {/*Nav Box*/}
                        ...
                        <div className="outer-box"> 
                            ...
                            <div className="divider"></div>
                                ...
                                <div className="btn-box">
                                    <Link href="page-contact" className="theme-btn btn-style-one hover-dark"><span className="btn-title">Request a Quote <i className="icon fa fa-arrow-right"></i></span></Link>
                                </div>
                                {/* Mobile Nav toggler */}
                        ...
                        <ul className="contact-list-one">
                            ...
                            <li>
                                ...
                                <div className="contact-info-box">
                                    ...
                                    <span className="title">Send Email</span>
                                    Mon - Sat 8:00 - 6:00 pm EST, Sunday - CLOSED
                                </div>
                            </li>
                        </ul>
