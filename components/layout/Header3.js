      ...
      <div className="inner-container">
        ...
        <div className="top-center"> 
          <ul className="list-style-one light">
            ...
            <li><i className="far fa-envelope"></i> <Link href="mailto:transtex@mail.com">transtex@mail.com</Link></li>
          </ul>
        </div>
      ...
      <div className="auto-container">
        ...
        <div className="main-box">
          <div className="logo-box">
            <div className="logo"><Link href="/"><img src="/images/logo.png" alt="" title="Transtex" /></Link></div>
          </div>
          {/*Nav Box*/}
